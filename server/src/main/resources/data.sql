INSERT INTO tbl_board (user_id,title,content,createDate
                      ,board_code,board_like,board_hit )
VALUES( 'testid','첫번째 게시물','여기는 첫번째 게시물 테스트입니다.','2021-11-30',1,0,10);

INSERT INTO tbl_board (user_id,title,content,createDate
                      ,board_code,board_like,board_hit ) VALUES( 'testid','두번째 게시물','여기는 두번째~~ 게시물 테스트입니다.','2021-11-30',1,0,0);
